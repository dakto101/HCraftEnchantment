...
public class MagicGem extends Item {
	...
	private static final String VIEW_CHANCE = "§7Click phải để xem xác suất.";
	
	public MagicGem() {
		super(ItemType.MAGIC_GEM, Arrays.asList(
			"§7Một loại vật phẩm bổ trợ trong phù phép cao cấp, ",
			"§7khi ép sách phù phép cao cấp thành công, có cơ hội ",
			"§7tăng thêm 1 cấp của một loại phù phép cao cấp bất kì."
