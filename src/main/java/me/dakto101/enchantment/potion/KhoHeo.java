...
public class KhoHeo extends CustomEnchantment {

	public KhoHeo() {
		super("Khô héo", "§7Đòn đánh cận chiến hoặc khi bị đánh có §f5%§7 xác suất "
				+ "gây hiệu ứng §fKhô héo III§7 lên mục tiêu trong §f(1 + Cấp)§7 giây. "
    ...
    public void applyOnHit(final LivingEntity user, final LivingEntity target, final int level, final EntityDamageByEntityEvent e) {
		...
		target.addPotionEffect(new PotionEffect(PotionEffectType.WITHER, duration, 2, true, true, true));
	}
