...
public class Mu extends CustomEnchantment {

	public Mu() {
		super("Mù", "§7Đòn đánh cận chiến hoặc khi bị đánh có §f5%§7 xác suất "
				+ "gây hiệu ứng §fMù III§7 lên mục tiêu trong §f(1 + Cấp)§7 giây. "
				+ "Xác suất tăng thành §f10%§7 đối với đòn đánh xa.", 15);
		setCanStack(true);
    ...
    public void applyOnHit(final LivingEntity user, final LivingEntity target, final int level, final EntityDamageByEntityEvent e) {
		...
		target.addPotionEffect(new PotionEffect(PotionEffectType.BLINDNESS, duration, 2, true, true, true));
	}
