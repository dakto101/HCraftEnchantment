...
public class Doc extends CustomEnchantment {

	public Doc() {
		super("Độc", "§7Đòn đánh cận chiến hoặc khi bị đánh có §f5%§7 xác suất gây "
				+ "hiệu ứng §fĐộc III§7 cho mục tiêu trong §f(1 + Cấp)§7 giây. "
				+ "Xác suất tăng thành §f10%§7 đối với đòn đánh xa.", 5d);
		setCanStack(true);
    ...
    public void applyOnHit(final LivingEntity user, final LivingEntity target, final int level, final EntityDamageByEntityEvent e) {
		...
		target.addPotionEffect(new PotionEffect(PotionEffectType.POISON, duration, 2, true, true, true));
	}
