...
public class HoiPhuc extends CustomEnchantment {

	public HoiPhuc() {
		super("Hồi phục", "§7Đòn đánh cận chiến hoặc khi bị đánh có §f5%§7 xác suất "
				+ "nhận hiệu ứng §fHồi phục II§7 trong §f(1 + Cấp)§7 giây. "
