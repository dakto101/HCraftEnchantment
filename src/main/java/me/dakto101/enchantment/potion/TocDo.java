...
public class TocDo extends CustomEnchantment {

	public TocDo() {
		super("Tốc độ", "§7Đòn đánh cận chiến hoặc khi bị đánh có §f5%§7 xác suất "
				+ "nhận hiệu ứng §fTốc độ II§7 trong §f(1 + Cấp)§7 giây. "
    ...
    public void applyOnHit(final LivingEntity user, final LivingEntity target, final int level, final EntityDamageByEntityEvent e) {
		...
		user.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, duration, 1, true, true, true));
	}
