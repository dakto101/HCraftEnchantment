...
public class SucManh extends CustomEnchantment {

	public SucManh() {
		super("Sức mạnh", "§7Đòn đánh cận chiến hoặc khi bị đánh có §f5%§7 xác suất "
				+ "nhận hiệu ứng §fSức mạnh II§7 trong §f(1 + Cấp)§7 giây. "
